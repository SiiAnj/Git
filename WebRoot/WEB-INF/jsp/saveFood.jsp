...
<div id="MainArea">
	...
	<!-- 表单内容 -->
	<form action="saveFood.do" method="post" ><!-- enctype="multipart/form-data" -->
		<!-- 本段标题（分段标题） -->
				...
				<div class="ItemBlock2">
					<table cellpadding="0" cellspacing="0" class="mainForm">
						...
						<!-- <tr>
							...
							<td>
								<a href="toSaveImg.do"  class="FunctionButton">上传</a>
								<input type="text" name="img" class="InputStyle" value=""/>
