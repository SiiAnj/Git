...
<div id="MainArea">
	<!-- 表单内容 -->
	<!-- 表单内容 -->
	<form action="../updateFood.do" method="post" ><!-- enctype="multipart/form-data" -->
		<!-- 本段标题（分段标题） -->
					...
					<table cellpadding="0" cellspacing="0" class="mainForm">
						...
						<tr>
							...
							<td>
								...
								<input type="text" name="foodName" class="InputStyle" value="${F.foodName}"/> 
							</td>
						</tr>
						 ...
						 <tr>
                            ...
                            <select name="foodType_id" style="width:80px">
	                            <c:forEach items="${list}" var="ft">
			   						<option value="${ft.id}" id="${ft.id}">${ft.typeName}</option>
			   					</c:forEach>
                            </select>
						</tr>
						...
						<tr>
							<td>价格</td>
							<td><input type="text" name="price" class="InputStyle" value="${F.price}"/> </td>
						</tr>
                        <tr>
							<td>会员价格</td>
							<td><input type="text" name="mprice" class="InputStyle" value="${F.mprice}"/> </td>
						</tr>
						
						<tr>
							<td>简介</td>
							<td><textarea name="remark" class="TextareaStyle">${F.remark}</textarea></td>
						</tr>
						<tr>
